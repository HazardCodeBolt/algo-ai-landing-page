      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">We provide various topic analysis features</h2>
            <p className="text-xl text-gray-400">Explore the multifaceted analyses our tool offers</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">Discern positive, negative, and neutral sentiments from tweets and Dive into context and content to grasp precise user emotions.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Trend Discovery</h4>
              <p className="text-lg text-gray-400 text-center">Identify common topics through word and phrase frequencies, Gauge engagement levels and impact to pinpoint the most compelling subjects.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Engagement Analysis</h4>
              <p className="text-lg text-gray-400 text-center">Uncover tweet counts, likes, and retweets to gauge user involvement and Assess interaction levels for insights into user interest.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Geographical Analysis</h4>
              <p className="text-lg text-gray-400 text-center">Gain insights into user locations and topic distribution in specific regions and Harness geographical data for targeted market strategies.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Target Audience Analysis</h4>
              <p className="text-lg text-gray-400 text-center">Understand audience characteristics and preferences to tailor future communication strategies based on data-driven insights.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Event Summaries</h4>
              <p className="text-lg text-gray-400 text-center">Access simplified yet comprehensive summaries of events and make informed decisions based on clear, concise information.</p>
            </div>
